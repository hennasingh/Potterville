...
7. I get these errors in console, when user presses on quit button while in the middle of the game. It points to content script and `<!DOCTYPE HTML>` tag in index.html file. The same errors also happen when timer ends, and the screen changes to end.html page. This was not part of my code but it got resolved by turning off you tube ad blocker extension.
